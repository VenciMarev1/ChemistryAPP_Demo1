...
public class PeriodicTableLayout : MonoBehaviour
{
   ...
   // List<GameObject> El = new List<GameObject>();
    ...
    private string[] elementTypes = new string[]
    {
        ...
        "Metalloids",           // 31 - Gallium
        "Metalloids",           // 32 - Germanium
        "Reactive non-metals",  // 33 - Arsenic
        "Metalloids",           // 34 - Selenium
        ...
        "Metalloids",           // 49 - Indium
        "Metalloids",           // 50 - Tin
        "Post-transition metals", // 51 - Antimony
        ...
        "Actinides",            // 72 - Hafnium
        "Actinides",            // 73 - Tantalum
        "Actinides",            // 74 - Tungsten
        "Actinides",            // 75 - Rhenium
        "Actinides",            // 76 - Osmium
        "Actinides",            // 77 - Iridium
        "Actinides",            // 78 - Platinum
        "Post-transition metals", // 79 - Gold
        "Post-transition metals", // 80 - Mercury
        "Post-transition metals", // 81 - Thallium
        "Metalloids",           // 82 - Lead
        "Metalloids",           // 83 - Bismuth
        "Post-transition metals", // 84 - Polonium
        "Noble gases",          // 85 - Radon
        "Lanthanides",          // 86 - Francium
        "Actinides",            // 87 - Radium
        "Unknown properties",   // 88 - Rutherfordium
        "Unknown properties",   // 89 - Dubnium
        "Unknown properties",   // 90 - Seaborgium
        "Unknown properties",   // 91 - Bohrium
        "Unknown properties",   // 92 - Hassium
        "Unknown properties",   // 93 - Meitnerium
        "Unknown properties",   // 94 - Darmstadtium
        "Unknown properties",   // 95 - Roentgenium
        "Unknown properties",   // 96 - Copernicium
        "Unknown properties",   // 97 - Nihonium
        "Unknown properties",   // 98 - Flerovium
        "Unknown properties",   // 99 - Moscovium
        "Unknown properties",   // 100 - Livermorium
        "Unknown properties",   // 101 - Tennessine
        "Unknown properties",   // 102 - Oganesson
    };
    ...
    string GetElementSymbol(int atomicNumber)
    {
        string[] elementSymbols = new string[]
        {
            ...
            "Tl", "Pb", "Bi", "Po", "At", "Rn", "Fr", "Ra", "Rf", "Db", "Sg", "Bh", "Hs", "Mt", "Ds", "Rg", "Cn", "Nh", "Fl", "Mc",
            "Lv", "Ts", "Og"
        };
    ...
    string GetElementFullName(int atomicNumber)
    {
        string[] elementFullNames = new string[]
        {
            ...
            "Thallium", "Lead", "Bismuth", "Polonium", "Astatine", "Radon", "Francium", "Radium", "Rutherfordium", "Dubnium",
